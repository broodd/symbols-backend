...
export class ConfigService {
   ...
   */
  public get<T = NodeJS.ProcessEnv>(key: string, initial?: T): T {
    ...
    if (!variable && initial === undefined) throw TypeError(`The ${key} cannot be undefined`);
    else if (initial !== undefined) return initial;
